    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="halamanadmin.php">
                ...
                <div class="sidebar-brand-text mx-3">PERPUSTAKAAN <sup>KITA</sup></div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseOne" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="pinjam.php">Peminjaman</a>
            ...
            <!-- Nav Item - Tables -->
            <li class="nav-item">
                <a class="nav-link" href="index.php" onclick="return confirm('Yakin');">
                    <i class="fas fa-fw fa-cog"></i>
                    <span>Log Out</span></a>
            </li>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-12 mt-2 shadow h-100 py-2">
                                <div class="jumbotron jumbotron-fluid">
                                    <div class="container">
                                      <h1 class="display-4">Selamat Datang</h1>
                                      <p class="lead">Ini adalah Sistem Informasi PERPUSTAKAAN</p>
                                    </div>
                                  </div>
                            </div>
                        </div>
